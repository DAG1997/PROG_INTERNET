...
namespace PROJETO_PNET.Controllers
{
    public class TarefasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TarefaId,Nivel,NomeTarefa,DataTarefa,CargoId")] Tarefa tarefa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TarefaId,Nivel,NomeTarefa,DataTarefa,CargoId")] Tarefa tarefa)
        {
